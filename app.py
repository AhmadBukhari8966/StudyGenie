...
Get Outlook for iOS
From: Hiruni Galbokka Hewa <hgalbokkahewa@atu.edu>
Sent: Friday, March 20, 2026 8:47:05 PM
To: zh64445@truman.edu <zh64445@truman.edu>
Subject: Re: StudyGenie
 
Ahmad, use command prompt to enter those 4 codes one by one. 
...
Get Outlook for iOS
From: Hiruni Galbokka Hewa
Sent: Friday, March 20, 2026 8:45:28 PM
To: zh64445@truman.edu <zh64445@truman.edu>
Subject: StudyGenie
...
def extract_text_from_uploaded_file(uploaded_file):
    """
    Reads text from txt / md / csv files.
    PDF and DOCX parsing are not included in this minimal version.
    """
    if uploaded_file is None:
        return ""
...
st.title("🎓 StudyGenie")
st.subheader("AI-Driven Solutions for University-Level Problems")
